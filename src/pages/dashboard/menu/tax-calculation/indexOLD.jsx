...
const TaxCalculation = ({
  ...
  const handleGeneratePdf = () => {
    ...
    doc.html(reportTemplateRef.current, {
      async callback(doc) {
        await doc.save('Tax credit report - '+ convetproductionIdToName(redux_production_id));
      },
    });
  };
  ...
  useEffect(() => {
    ...
    const getList = () => {
      ...
      const prod_loca = production_location_list.filter((item) => item.production_fid == redux_production_id)
  ...
  region_grant_list.map((regon_grant) => {
    if (regon_grant.region_fid == 13 && totalNortherONLabour >= regon_grant.grant_from && totalNortherONLabour <= regon_grant.grant_to) {

      console.log("regon_grant.region_fid ---- ", regon_grant.region_fid, regon_grant.grant_from, regon_grant.grant_to)
  ...
  tax_calc_part_two.map((item2) => {
    if (item2.province == "ON" && item2.tax_credit_name == "OFTTC" && totalONCosts_Per >= 75) {
  ...
  useEffect(() => {
    const getCalc = () => {
      ...
      if (production_genre != undefined) {
        ...
        //------------------ Documentary ---- 2
        if (genres[0]?.toLowerCase() == "documentary" || genres[0]?.toLowerCase() == "drama") {
          ...
          if (totalONCosts_Per >= 75) {
            ...
            if (genres[2]?.toLowerCase() == "feature") {
              ...
              if (outsideGTA_days >= feature_min_days && outsideGTA_per >= feature_min_per) {
                ...
                console.log("Outside GTA > 5 days and Outside GTA days > 85 % , total  " + ONLabourCredit + "% , bonus % " + bonus_per);
            ...
            //------------------ series ---- 2.3.1
              ...
              if (outsideGTA_days >= episode_count && outsideGTA_per >= series_min_per) {
                ...
                // });
                bonus_per = bonus_percentage;
                console.log("Outside GTA > episode_count and Outside GTA days > 85 % , total  " + ONLabourCredit + "% , bonus % " + bonus_per);

              } else {
                console.log("Outside GTA < episode_count days OR Outside GTA days < 85 %");
              }
            ...
            if (genres[0]?.toLowerCase() == "drama") {
              ...
              totalNUM_Ontario_days_per = (totalNUM_Ontario_days * 100) / total_shooting_days;

              console.log("totalNUM_Ontario_days_per ", totalNUM_Ontario_days_per)
              ...
              if (outsideGTA_days >= episode_count && outsideGTA_days >= feature_min_days && outsideGTA_per >= feature_min_per && totalNUM_Ontario_days_per > 85) {
                ...
                console.log("outsideGTA_days >= episode_count && outsideGTA_days >= 5 && outsideGTA_per >= 85 , episode count = " + episode_count + ", " + ONLabourCredit + "% , bonus % " + bonus_per);

              } else {
                console.log("outsideGTA_days < episode_count OR outsideGTA_days < 5 OR outsideGTA_per < 85 , episode count = " + episode_count + ", " + ONLabourCredit + "% , bonus % " + bonus_per);
                seterrorMsg("Location days is less than 85% - not eligible OFTTC");
              }
  ...
  if (errorMsg == "not eligible OFTTC" || errorMsg == "Total spent in Ontario < 75%, not eligible." || errorMsg == "Location days is less than 85% - not eligible OFTTC") ONLabourCredit = 0;
  ...
  return (
    <div className="p-5 w-full">
      ...
      <div ref={reportTemplateRef} className="p-4 bg-white sm:p-6 dark:bg-gray-800 rounded-xl w-[900px]">
        <div className="mx-auto max-w-screen-xl text-xs">
          <div className="mb-8 md:mb-8 w-[200px] ">
            <span className="flex items-center">
              <span className="self-center text-[15px] font-semibold whitespace-nowrap dark:text-white text-stone-500">
                Tax - Credit Calculation Report: {convetproductionIdToName(redux_production_id)}
              </span>
            </span>
          </div>
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400 w-[130px] text-right">
                  ...
                  <li className="mb-2">
                    <span className="">{(ONLabourCredit - bonus)}% + {bonus}% Bonus</span>
                  </li>
                  <li className="mb-2">
                    <span className="">
          ...
          {(errorMsg == "not eligible OFTTC" || errorMsg == "Total spent in Ontario < 75%, not eligible." || errorMsg == "Location days is less than 85% - not eligible OFTTC") && (
            <p className="mb-2 text-left">
              <span className="text-red-500 font-bold">{genre1} - {errorMsg}</span>
              <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-6" />
            </p>
          )}
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                      ...
                      <li className="mb-2">
                        <span className="">Total Costs - OPSTC Credit - NOHFC</span>
                      </li>
                      <li className="mb-2">
                  ...
                  <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400 w-[130px] text-right">
                      ...
                      <li className="mb-2">
                        {TotalCosts_OPSTC_CREDIT_NOHFC.toLocaleString(0, "en-US", {
                          style: "currency",
                          currency: "USD",
                        })}
                      </li>
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                      ...
                      <li className="mb-2">
                        <span className="">Total Costs - OFTC Credit - NOHFC</span>
                      </li>
                      <li className="mb-2">
                        <span className="">Other Exclusions</span>
                      </li>
                  ...
                  <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400 w-[130px] text-right">
                      ...
                      <li className="mb-2">
                        {OFTTC_TotalCosts_CREDIT_NOHFC.toLocaleString(0, "en-US", {
                          style: "currency",
                          currency: "USD",
                        })}
                      </li>
                      ...
                      <li className="mb-2">
                        <span className=" text-right ">
                          {OFTTC_Total_Eligible_costs.toLocaleString(0, "en-US", {
                            style: "currency",
                            currency: "USD",
                          })}
                        </span>
