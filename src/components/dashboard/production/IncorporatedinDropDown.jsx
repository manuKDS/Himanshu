...
const IncorporationinDropdown = ({ list, convertOrgTypeName, state }) => {
  const { incorporation_in, setincorporation_in, errorincorporation_in } =
    state;
