          ...
          >
            <Dialog.Panel className='mx-auto w-[600px] rounded-[15px] bg-white overflow-hidden'>
              <div className='p-6 bg-blue-500 text-white text-xl font-semibold'>
                Update Feature / Series
              </div>
              <div className='p-5'>
                <div className='space-y-3 text-sm'>

                  <div className="grid grid-cols-1 gap-0 ">
                    <label  className="block mb-1 text-sm font-medium text-gray-700 dark:text-white ">Feature / Series Name</label>
                    <input
                      type='text'
                      value={production}
                      onChange={(e) => { setproduction(e.target.value); seterrorproduction("") }}
                      placeholder='Feature / Series Name'
