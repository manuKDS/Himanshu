...
export default function ActionBtn({ countryId, data, tableReload, countryList }) {
  ...
  const deleteNow = () => {
    deleteHandel(countryId);
  };

  async function deleteHandel(countryId) {
    try {
      setLoading(true);

      const res = await axiosInstance.delete(
        process.env.API_SERVER + "country/" + countryId
      );
    ...
    <div>
      <div className="flex gap-8">
        ...
        {loading ? (
          ...
          //<button onClick={() => deleteHandel(countryId)}>
