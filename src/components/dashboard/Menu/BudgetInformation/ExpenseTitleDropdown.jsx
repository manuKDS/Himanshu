...
const ExpenseTitleDropdown = ({ list, convertExpenseId, state, error = false }) => {
  const { expenseTitle, setExpenseTitle } = state;
  ...
  const convertedVal = convertExpenseId(expenseTitle);
...
export default ExpenseTitleDropdown;
