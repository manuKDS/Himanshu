  ...
  return (
    <Combobox value={orgId} onChange={setOrgId} as='div' className='relative'>
      ...
      {filteredList.length > 0 && (
        <Combobox.Options className='absolute mt-1 max-h-[60px] overflow-y-auto w-full rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-gray-300 ring-opacity-5 focus:outline-none sm:text-sm z-10'>
