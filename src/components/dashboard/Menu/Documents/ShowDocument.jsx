...
import TaxAssistanceDropDown from "./DocumentTypeDropDown";
import {useRouter} from 'next/router';

export default function ShowDocument({ isOpen, setIsOpen, data, state, fn, tax_credit_id, tableReload }) {
            ...
            <Dialog.Panel className='mx-auto w-[600px] rounded-[15px] bg-white overflow-hidden'>
              ...
              <div className='p-5'>
                <div className='space-y-3 text-sm'>
                    ...
                    <img src={`/uploads/${data.document_path}`} alt="" 
                    className='w-[600px] '
                    />
