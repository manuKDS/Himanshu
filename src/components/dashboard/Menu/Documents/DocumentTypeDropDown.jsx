...
const DocumentTypeDropDown = ({ list, state, error = false }) => {
  const { documentType, setDocumentType } = state;
  ...
  return (
    <Combobox value={documentType} onChange={setDocumentType} as='div' className='relative'>
