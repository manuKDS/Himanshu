...
export default function UpdateDataSeason({ isOpen, setIsOpen, data, tableReload, productionId, state }) {
  ...
  const [episodes, setepisodes] = useState(data.episode_cnt);
  ...
  const updateData = async () => {
    ...
    if (production != "" && errorstatus == "") {  // && province_fid != "") {
      ...
      const data = {
        ...
        season: production_changecase,
      };
      console.log("Saving.....")
      setIsOpen(false);
      try {
        const res = await axiosInstance.put(process.env.API_SERVER + "production/season/" + productionId, data);
        // setorg_fid(1);
        // setupdated_by(1);
        // setproduction("");
        // setstatus_fid("");
              ...
              <div className='p-5'>
                <div className='space-y-3 text-sm'>
                  ...
                  <div className="grid grid-cols-1 gap-2 divide-x">
                    <label  className="block mb-1 text-sm font-medium text-gray-700 dark:text-white ">Season Name</label>
                  ...
                  <div className="grid grid-cols-2 gap-2 divide-x">
                    <div>
                      <label  className="block mb-1 text-sm font-medium text-gray-700 dark:text-white ">Genre Name</label>
                      <GenreDropdown
                    ...
                    <div>
                      <label  className="block mb-1 text-sm font-medium text-gray-700 dark:text-white ">Distributor</label>
                      <DistributorDropdown
                  ...
                  <div className="grid grid-cols-2 gap-2 divide-x">
                    <div>
                      <label  className="block mb-1 text-sm font-medium text-gray-700 dark:text-white ">Incorporation Name</label>
                      <input
                        type='text'
                    ...
                    <div>
                      <label  className="block mb-1 text-sm font-medium text-gray-700 dark:text-white ">Incorporation In</label>
                  ...
                  <div className="grid grid-cols-2 gap-2 divide-x">
                    <div>
                      <label  className="block mb-1 text-sm font-medium text-gray-700 dark:text-white ">Incorporation Date</label>
                      <input
                        type='date'
                    ...
                    <div>
                      <label  className="block mb-1 text-sm font-medium text-gray-700 dark:text-white ">No. of Episodes</label>
                      <input
                        type='number' min={0}
                        value={episodes}
                        onChange={(e) => { setepisodes(e.target.value); seterrorproduction("") }}
