...
const ProvinceDropDown = ({ list, convetOrgTypeName, state }) => {
  ...
  //console.log(province_fid);
  return (
    <Combobox value={province_fid} onChange={setprovince_fid} as='div' className='relative z-100'>
      <div className='relative'>
        <Combobox.Input
          ...
          className={errorprovince_fid != "" ? 'px-5 h-[45px] w-full bg-red-200 rounded-md outline-none placeholder:text-gray-500' :
