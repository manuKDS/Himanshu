...
const StatusDropdown = ({ list, convetOrgTypeName, state }) => {
  ...
  return (
    <Combobox value={status_fid} onChange={setstatus_fid} as='div' className='relative z-100'>
      <div className='relative'>
        <Combobox.Input
          ...
          className={errorstatus != "" ? 'px-5 h-[45px] w-full bg-red-200 rounded-md outline-none placeholder:text-gray-500' :
