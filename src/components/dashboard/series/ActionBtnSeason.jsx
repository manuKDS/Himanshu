...
import UpdateDataSeason from "./UpdateDataSeason";

export default function ActionBtnSeason({ productionId, data, tableReload, state }) {
  ...
  return (
    <div>
      ...
      <UpdateDataSeason isOpen={isOpen} setIsOpen={setIsOpen} data={data} productionId={productionId} state={state} tableReload={tableReload} />
