...
const AddCountryDropdown = ({
  ...
  const convertedVal = convertCountryId(
    ...
    >
      <div className='relative'>
        <Combobox.Input
          ...
          placeholder='Country'
          className='px-5 h-[45px] w-full disabled:bg-[#bababa]/50 disabled:cursor-not-allowed bg-[#E9E9E9] rounded-md outline-none placeholder:text-gray-500'
        />
