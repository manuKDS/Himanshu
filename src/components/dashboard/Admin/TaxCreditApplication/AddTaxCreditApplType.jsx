...
const Lists = ["Provincial", "Federal"];

const AddTaxCreditApplType = ({ state }) => {
  const { applType, setApplType, errapplType } = state;
...
export default AddTaxCreditApplType;
