...
const Lists = ["Part - A", "Part - B", "Part - C"];

const AddApplSubType = ({ state }) => {
  const { applSubType, setApplSubType, errSubType } = state;
