...
export default function ActionBtn({ genreId, data, tableReload }) {
  ...
  const deleteNow = () => {
    deleteHandel(genreId);
  };

  async function deleteHandel(genreId) {
    try {
      setLoading(true);

      const res = await axiosInstance.delete(
        process.env.API_SERVER + "genre/" + genreId
      );
    ...
    <div>
      <div className="flex gap-8">
        ...
        {loading ? (
          ...
          //<button onClick={() => deleteHandel(genreId)}>
